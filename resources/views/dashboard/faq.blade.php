                ...
                <div id="faq-accordion-2" class="accordion accordion-boxed mt-5">
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-1" class="accordion-collapse collapse show"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                Al igual que muchas otras aplicaciones basadas en IA, MaestroIA se basa en los modelos
                                de OpenAI, sin
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-2" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                ...
                                MaestroIA no tiene límites de uso para las solicitudes, solo te pedimos que seas justo y
                                razonable con
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-3" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                En ocasiones muy raras, MaestroIA puede tener dificultades para conectarse a los modelos
                                de OpenAI que lo impulsan. Esto puede deberse a una demanda excepcionalmente alta en su
                                extremo
                                o a una conexión a internet menos que perfecta en tu extremo. Si tu conexión a internet
                                es sólida, lo mejor que puedes
                                hacer es simplemente intentarlo de nuevo, ya que el problema generalmente no persiste
                                por mucho tiempo.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-4" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                Si tienes una idea para una herramienta, por favor avísanos a través del botón "Idea de
                                Herramienta" en la
                                página del "Panel de Control". ¡Haremos nuestro mejor esfuerzo para construirla para ti
                                tan pronto como sea
                                posible!
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-5" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                ...
                                tarjeta". Esto abrirá el portal de pago de Stripe, donde podrás cancelar tu suscripción.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        ...
                        <div id="faq-accordion-collapse-6" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                Podrás seguir utilizando MaestroIA hasta el final del período por el cual has realizado
                                el pago.
                            </div>
                        </div>
                    </div>
