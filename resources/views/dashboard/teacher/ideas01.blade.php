...
<div class="grid grid-cols-12 gap-6">
    ...
    <div class="col-span-12 lg:col-span-4 2xl:col-span-4 flex lg:block flex-col-reverse">
        <div class="intro-y box mt-5">
            <form method="POST" action="{{ route('teacher.generateIdeas') }}">
                @csrf
                <div class="relative flex items-center p-5">
                    ...
                    <div class="ml-4 mr-auto">
                        <div class="font-medium text-base">Ideas para trabajar las differentes competencies de la LOMLOE
                        </div>
                    </div>
                </div>
                <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <div class="mt-5">
                        <label for="lesson-description" class="form-label">Competencia</label>
                        <!-- Textarea for Lesson Description -->
                        <textarea id="lesson-description"
                            placeholder="Competencia lingüística, Competencia matemática, Competencia digital, Conciencia y expresiones culturales, etc."
                            name="competencies" required
                            class="form-control h-40"><?php echo htmlspecialchars($competencies); ?></textarea>
                    </div>
                </div>
        ...
        <div class="intro-y box lg:mt-5">
            ...
            <div class="p-5">
                ...
                <div class="my-10">
                    <?php
                    if (empty($ideas)) {
                        echo "Los resultados se mostrarán aquí. ¡Haz clic en '✨Genera Competencias' para comenzar el proceso!";
                    } else {
                  
                    echo '<div class="font-medium text-md">' . nl2br($ideas) . '</div>';
                    }
                    ?>
                </div>
                <?php 
                ...
                <div class="my-2 flex">
                    <a target="_blank"
                        href="{{ route('teacher.downloadIdeasDocx', ['ideas' => urlencode(json_encode($ideas))]) }}"
