        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($ideasTool->free_status == 1 || $user->is_paid == 1)
                        <a href="{{ route('teacher.showIdeasTool') }}">
                            <div style="height: 100% !important;" class="report-box zoom-in">
                                <div class="box p-5 h-full py-10">
                                    <div class="flex">
                                        <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"
                                            id="Student">
                                            <path
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6"
                                        style="font-family: Inter; font-size: 25px; font-weight: 600;">Ideas
                                        Competencias
                                    </div>
                                    <div class="text-base text-slate-500 mt-1">Ideas para trabajar las differentes
                                        competencies de la LOMLOE
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <div style="height: 100% !important;" class="report-box">
                            <div class="box p-5 h-full py-6">
                                ...
                                <div style="font-family: Inter; font-size: 25px; font-weight: 600;"
                                    class="text-3xl font-medium leading-8 mt-6 mb-2">Ideas
                                    Competencias
                                </div>
                                <div class="flex items-baseline align-middle" style="width: 80%; align-items: center;">
                                    <div class="text-base text-slate-500 mt-1"><span class="font-bold">¡Hazte
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($behavior->free_status == 1 || $user->is_paid == 1)
                        <a href="{{ route('teacher.showBehaviorTool') }}">
                            <div style="height: 100% !important;" class="report-box zoom-in">
                                <div class="box p-5 h-full py-10">
                                    <div class="flex">
                                        <svg style="width: 58px; !important" xmlns="http://www.w3.org/2000/svg"
                                            data-name="Layer 1" viewBox="0 0 64 64" id="Moody">
                                            <path
                                    ...
                                    <div class="text-3xl font-medium leading-8 mt-6"
                                        style="font-family: Inter; font-size: 25px; font-weight: 600;">Manejo de
                                        Comportamiento
                                    </div>
                                    <div class="text-base text-slate-500 mt-1">Comportamiento: Estrategias para manejar
                        ...
                        <div style="height: 100% !important;" class="report-box">
                            <div class="box p-5 h-full py-6">
                                ...
                                <div style="font-family: Inter; font-size: 25px; font-weight: 600;"
                                    class="text-3xl font-medium leading-8 mt-6 mb-2">Manejo de Comportamiento
                                </div>
                                <div class="flex items-baseline align-middle" style="width: 80%; align-items: center;">
                                    <div class="text-base text-slate-500 mt-1"><span class="font-bold">¡Hazte
                                            Premium!</span>
