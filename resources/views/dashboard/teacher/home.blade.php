                            ...
                            @else
                                <div class="report-box">
                                    <div class="box p-5 py-6">
                                        ...
                                        <div class="text-3xl font-medium leading-8 mt-6 mb-2">Modelos de Texto Generator
                                        </div>
                                        <div class="flex items-baseline align-middle"
                                            style="width: 80%; align-items: center;">
                                            <div class="text-base text-slate-500 mt-1">Want access? <span
                                ...
                                <a href="{{ route('teacher.showConceptExplainer') }}">
                                    <div class="report-box zoom-in">
                                        <div class="box p-5 py-10">
                                            ...
                                            <div class="text-base text-slate-500 mt-1">Genera preguntas de comprensión con
                                                la IA
                                                a
