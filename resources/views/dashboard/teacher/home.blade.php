                ...
                <div class="col-span-12 mt-8">
                    ...
                    <div class="alert alert-primary show mb-2" role="alert">
                        <div class="flex items-center">
                            <div class="font-medium text-lg">¿Necesitas ayuda?</div>
                            <div class="text-xs bg-white px-1 rounded-md text-slate-700 ml-auto">Nuevo</div>
                        </div>
                        <div class="mt-3">¿Encontraste un error o fallo? Repórtalo en: ayuda@maestroia.com <br> ¿Tienes
                            una gran idea para una herramienta? Háznoslo saber en: Admin@maestroia.com</div>
                    </div>
                                        ...
                                        <div class="box p-5 h-full py-10">
                                            <div class="flex">
                                                <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 48 48" id="OnlineLesson">
                                                    <g data-name="online lesson" fill="#595bd4"
                                ...
                                <a href="{{ route('teacher.comprehension.form') }}">
                                    <div style="height: 100% !important;" class="report-box zoom-in">
                                        <div class="box p-5 h-full py-10">
                                            <div class="flex">
                                                <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg"
                                                    data-name="Layer 1" viewBox="0 0 128 128" id="Teacher">
                                                    <path
                                ...
                                <a href="{{ route('teacher.showConceptExplainer') }}">
                                    <div style="height: 100% !important;" class="report-box zoom-in">
                                        <div class="box p-5 h-full py-10">
                                            <div class="flex">
                                                <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg"
                                                    data-name="Layer 1" viewBox="0 0 64 64" id="ConceptExchange">
                                                    <rect width="2" height="2" x="6" y="26"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="6" y="30"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="6" y="34"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="6" y="38"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="6" y="42"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="14" y="46"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="18" y="46"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="6" y="46"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="10" y="46"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <polygon points="22 50 26 47 22 44 22 50" fill="#595bd4"
                                                        class="color000000 svgShape"></polygon>
                                                    <rect width="2" height="2" x="56" y="36"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="56" y="32"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="56" y="28"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="56" y="24"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="56" y="20"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="48" y="16"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="44" y="16"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="56" y="16"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <rect width="2" height="2" x="52" y="16"
                                                        fill="#595bd4" class="color000000 svgShape"></rect>
                                                    <polygon points="42 20 42 14 38 17 42 20" fill="#595bd4"
                                                        class="color000000 svgShape"></polygon>
                                                    <circle cx="45" cy="51" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                    <circle cx="37" cy="51" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                    <path
                                                        ...
                                                        fill="#595bd4" class="color000000 svgShape"></path>
                                                    <circle cx="53" cy="51" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                    <circle cx="19" cy="13" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                    <circle cx="27" cy="13" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                    <path
                                                        ...
                                                        fill="#595bd4" class="color000000 svgShape"></path>
                                                    <circle cx="11" cy="13" r="1" fill="#595bd4"
                                                        class="color000000 svgShape">
                                                    </circle>
                                                </svg>
                                                <div class="ml-auto">
                                ...
                                <a href="{{ route('teacher.showWorksheetGenerator') }}">
                                    <div style="height: 100% !important;" class="report-box zoom-in">
                                        <div class="box p-5 h-full py-10">
                                            <div class="flex">
                                                <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 80 80" id="Clipboard">
                                                    <path
                                        ...
                                        <div class="box p-5 h-full py-10">
                                            <div class="flex items-baseline">
                                                <svg style="width: 58px;" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <line x1="32" x2="224" y1="104" y2="104"
                                                        fill="none" stroke="#595bd4" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="16"
                                                        class="colorStroke000000 svgStroke"></line>
                                                    <line x1="32" x2="224" y1="152" y2="152"
                                                        fill="none" stroke="#595bd4" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="16"
                                                        class="colorStroke000000 svgStroke"></line>
                                                    <line x1="88" x2="88" y1="104" y2="200"
                                                        fill="none" stroke="#595bd4" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="16"
                                                        class="colorStroke000000 svgStroke"></line>
                                                </svg>
