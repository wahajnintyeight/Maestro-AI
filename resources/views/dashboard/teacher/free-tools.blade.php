    ...
    <div class="col-span-12 2xl:col-span-12">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 mt-8">
                ...
                @if ($free_tools_available == 1)

                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($lessonPlanner->free_status == 1)
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($comprehensionGenerator->free_status == 1 )
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($conceptExplainer->free_status == 1 )
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($worksheetGenerator->free_status == 1 )
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($rubricGenerator->free_status == 1 )
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                        @if ($slidesGenerator->free_status == 1 )
                ...
                <div class="flex justify-center mx-auto">
                    <h1 class="font-bold text-lg">No Free Tools Available Yet.</h1>
                </div>
                @endif
            </div>
        </div>
