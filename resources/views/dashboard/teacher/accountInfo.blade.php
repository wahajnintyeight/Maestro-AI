                                            ...
                                            <div class="mb-6 grid gap-6 sm:grid-cols-2 md:mb-8 lg:grid-cols-4 lg:gap-8">
                                                ...
                                                <div class="flex flex-col rounded-lg border p-4 pt-6">
                                                    ...
                                                    <div class="flex gap-2">
                                                        ...
                                                        <span class="text-gray-600 text-left">Unlimited file storage</span>
                                                    </div>
                                                    <!-- check - end -->
                                                    ...
                                                    <div class="flex gap-2">
                                                        ...
                                                        <span class="text-gray-600 text-left">Unlimited bandwidth per month</span>
                                                    </div>
                                                    <!-- check - end -->
                                                    ...
                                                    <div class="flex gap-2">
                                                        ...
                                                        <span class="text-gray-600 text-left">1.000.000 tasks per month</span>
                                                    </div>
                                                    <!-- check - end -->
                                                    ...
                                                    <div class="flex gap-2">
                                                        ...
                                                        <span class="text-gray-600 text-left">Email and phone support</span>
                                                    </div>
                                                    <!-- check - end -->
