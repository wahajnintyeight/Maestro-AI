                                        ...
                                        <ul class="hidden mx-auto text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg shadow sm:flex w-96""
                                            ...
                                            <li class="w-full" role="presentation">
                                                <button
                                                    ...
                                                    id="annually-tab" data-tabs-target="#annually" type="button"
                                                    role="tab" aria-controls="annually"
                                                        ...
                                                        <div class="group relative row-start-1 md:col-span-2 lg:w-[36%]">
                                                            ...
                                                            <div class="relative space-y-8 p-8">
                                                                ...
                                                                <div class="overflow-hidden">
                                                                    <div class="-mr-20 flex items-end justify-center">
                                                                        <div class="flex">
                                                                            ...
                                                                            <span
                                                                                class="leading-0 text-8xl font-bold text-gray-800 dark:text-white">{{ intval($plan->price) }}</span>
                                                                        </div>
                                                                        <div class="mb-2">
                                                                            <span
                                                                ...
                                                                <ul role="list"
                                                                    ...
                                                                    <li class="space-x-2">
                                                                        <span
                                                                            class="font-semibold text-primary">&check;</span>
