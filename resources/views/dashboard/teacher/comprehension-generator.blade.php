    ...
    <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                        <div>
                            ...
                            <select id="grade-level" required name="grade" class="form-select">
                                ...
                                <option value="1st Grade" <?php if ($grade == '1st Grade') {
                                    echo 'selected';
                                } ?>>1st Grade
                                </option>
                                <option value="2nd Grade" <?php if ($grade == '2nd Grade') {
                                    echo 'selected';
                                } ?>>2nd Grade
                                </option>
                                <option value="3rd Grade" <?php if ($grade == '3rd Grade') {
                                    echo 'selected';
                                } ?>>3rd Grade
                                </option>
                                <option value="4th Grade" <?php if ($grade == '4th Grade') {
                                    echo 'selected';
                                } ?>>4th Grade
                                </option>
                                <option value="5th Grade" <?php if ($grade == '5th Grade') {
                                    echo 'selected';
                                } ?>>5th Grade
                                </option>
                                <option value="6th Grade" <?php if ($grade == '6th Grade') {
                                    echo 'selected';
                                } ?>>6th Grade
                                </option>
                                <option value="7th Grade" <?php if ($grade == '7th Grade') {
                                    echo 'selected';
                                } ?>>7th Grade
                                </option>
                                <option value="8th Grade" <?php if ($grade == '8th Grade') {
                                    echo 'selected';
                                } ?>>8th Grade
                                </option>
                                <option value="9th Grade" <?php if ($grade == '9th Grade') {
                                    echo 'selected';
                                } ?>>9th Grade
                                </option>
                                <option value="10th Grade" <?php if ($grade == '10th Grade') {
                                    echo 'selected';
                                } ?>>10th
                                    Grade</option>
                                <option value="11th Grade" <?php if ($grade == '11th Grade') {
                                    echo 'selected';
                                } ?>>11th
                                    Grade</option>
                                <option value="12th Grade" <?php if ($grade == '12th Grade') {
                                    echo 'selected';
                                } ?>>12th
                                    Grade</option>
                            </select>
                        ...
                        <div class="mt-5">
                            ...
                            <select id="comprehension-focus" name="focus" required class="form-select">
                                <option value="Vocabulary" <?php if ($focus == 'Vocabulary') {
                                    echo 'selected';
                                } ?>>Vocabulary</option>
                                <option value="Literal Retrieval" <?php if ($focus == 'Literal Retrieval') {
                                    echo 'selected';
                                } ?>>Literal Retrieval</option>
                                <option value="Inference" <?php if ($focus == 'Inference') {
                                    echo 'selected';
                                } ?>>Inference</option>
                                <option value="Evaluation" <?php if ($focus == 'Evaluation') {
                                    echo 'selected';
                                } ?>>Evaluation</option>
                                <option value="Author Choice" <?php if ($focus == 'Author Choice') {
                                    echo 'selected';
                                ...
                                <option value="Summary and Prediction" <?php if ($focus == 'Summary and Prediction') {
                                    echo 'selected';
                                } ?>>Summary and Prediction</option>
                                <option value="Analysis of Language and Structure" <?php if ($focus == 'Analysis of Language and Structure') {
                                    echo 'selected';
                                } ?>>Analysis of Language
                                    and Structure</option>
                                <option value="Mixture of All" <?php if ($focus == 'Mixture of All') {
                                    echo 'selected';
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-8">
            ...
            proceso!";
                                ...
                                // Display questions
                                echo '<h3 class="text-lg">Questions</h3><ol style="list-style-position: inside;">';
                                foreach ($questions as $key => $question) {
                                    echo '<li><h5 class="text-lg leading-none mt-3">' . ($key + 1) . '. ' . $question->Question . '</h5></li>';
                                }
                                echo '</ol><br>';
                            
                                // Display answers
                                echo '<h3 class="text-lg">Answers</h3><ol style="list-style-position: inside;">';
                                foreach ($questions as $key => $question) {
                                    echo '<li><h5 class="text-lg font-normal">' . ($key + 1) . '. ' . ucfirst($question->Answer) . '</h5></li>';
                                }
                                echo '</ol>';
                            }
                        @endphp
